/**
 * src/services/HydrationService.js (v3.3.8)
...
export async function hydrateHouseholdData() {
  try {
    ...
    console.log('[HydrationService v3.3.8] Household data hydrated successfully into Store.');
    return { success: true, timestamp: Date.now() };
  } catch (err) {
    console.error('[HydrationService v3.3.8] Hydration failed:', err);
