const PLATEPLAN_CACHE = 'plateplan-shell-v29';
const PLATEPLAN_APP_VERSION = '2.3.2';
const PLATEPLAN_BUILD_ID = '2.3.2-v29';
const PLATEPLAN_LOCAL_SHELL = [
  ...
  './manifest.json',
  './firebase-config.js',
  './styles/tokens.css?v=2.3.2',
  './styles/components.css?v=2.3.2',
  './styles/responsive.css?v=2.3.2',
  './styles/print.css?v=2.3.2',
  './scripts/plateplan-app.js?v=2.3.2',
  './scripts/bootstrap.js?v=2.3.2',
  './scripts/main.js?v=2.3.2',
  './scripts/core/contracts.js?v=2.3.2',
  './scripts/core/store.js?v=2.3.2',
  './scripts/core/runtime.js?v=2.3.2',
  './scripts/services/firebase.js?v=2.3.2',
  './scripts/services/sync.js?v=2.3.2',
  './scripts/services/recovery.js?v=2.3.2',
  './scripts/services/updates.js?v=2.3.2',
  './scripts/ui/actions.js?v=2.3.2',
  './scripts/ui/navigation.js?v=2.3.2',
  './scripts/ui/workspaces.js?v=2.3.2',
  './scripts/features/create-legacy-view.js?v=2.3.2',
  './scripts/features/today.js?v=2.3.2',
  './scripts/features/recipes.js?v=2.3.2',
  './scripts/features/recipe-add.js?v=2.3.2',
  './scripts/features/ingredients.js?v=2.3.2',
  './scripts/features/products.js?v=2.3.2',
  './scripts/features/planner.js?v=2.3.2',
  './scripts/features/library.js?v=2.3.2',
  './scripts/features/shopping.js?v=2.3.2',
  './scripts/features/search.js?v=2.3.2',
  './scripts/features/data-quality.js?v=2.3.2',
  './scripts/features/preferences.js?v=2.3.2',
  './icon-192.png',
  './icon-512.png',
