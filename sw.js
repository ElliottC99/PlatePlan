const PLATEPLAN_CACHE = 'plateplan-shell-v19';
const PLATEPLAN_LOCAL_SHELL = [
  './',
  './PlatePlan.html',
  './manifest.json',
  './firebase-config.js',
  './styles/tokens.css?v=21.0',
  './styles/components.css?v=21.0',
  './styles/responsive.css?v=21.0',
  './styles/print.css?v=21.0',
  './scripts/plateplan-app.js?v=21.0',
  './scripts/main.js?v=21.0',
  './scripts/core/contracts.js?v=21.0',
  './scripts/core/store.js?v=21.0',
  './scripts/core/runtime.js?v=21.0',
  './scripts/services/firebase.js?v=21.0',
  './scripts/services/sync.js?v=21.0',
  './scripts/services/recovery.js?v=21.0',
  './scripts/services/updates.js?v=21.0',
  './scripts/ui/actions.js?v=21.0',
  './scripts/ui/navigation.js?v=21.0',
  './scripts/ui/workspaces.js?v=21.0',
  './scripts/features/create-legacy-view.js?v=21.0',
  './scripts/features/today.js?v=21.0',
  './scripts/features/recipes.js?v=21.0',
  './scripts/features/ingredients.js?v=21.0',
  './scripts/features/products.js?v=21.0',
  './scripts/features/planner.js?v=21.0',
  './scripts/features/library.js?v=21.0',
  './scripts/features/shopping.js?v=21.0',
  './scripts/features/data-quality.js?v=21.0',
  './scripts/features/preferences.js?v=21.0',
  './icon-192.png',
  './icon-512.png',
