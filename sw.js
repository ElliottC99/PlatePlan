const PLATEPLAN_CACHE = 'plateplan-shell-v23';
const PLATEPLAN_APP_VERSION = '21.3.1';
const PLATEPLAN_BUILD_ID = '21.3.1-v23';
const PLATEPLAN_LOCAL_SHELL = [
  './',
  './PlatePlan.html',
  './manifest.json',
  './firebase-config.js',
  './styles/tokens.css?v=21.3.1',
  './styles/components.css?v=21.3.1',
  './styles/responsive.css?v=21.3.1',
  './styles/print.css?v=21.3.1',
  './scripts/plateplan-app.js?v=21.3.1',
  './scripts/main.js?v=21.3.1',
  './scripts/core/contracts.js?v=21.3.1',
  './scripts/core/store.js?v=21.3.1',
  './scripts/core/runtime.js?v=21.3.1',
  './scripts/services/firebase.js?v=21.3.1',
  './scripts/services/sync.js?v=21.3.1',
  './scripts/services/recovery.js?v=21.3.1',
  './scripts/services/updates.js?v=21.3.1',
  './scripts/ui/actions.js?v=21.3.1',
  './scripts/ui/navigation.js?v=21.3.1',
  './scripts/ui/workspaces.js?v=21.3.1',
  './scripts/features/create-legacy-view.js?v=21.3.1',
  './scripts/features/today.js?v=21.3.1',
  './scripts/features/recipes.js?v=21.3.1',
  './scripts/features/ingredients.js?v=21.3.1',
  './scripts/features/products.js?v=21.3.1',
  './scripts/features/planner.js?v=21.3.1',
  './scripts/features/library.js?v=21.3.1',
  './scripts/features/shopping.js?v=21.3.1',
  './scripts/features/data-quality.js?v=21.3.1',
  './scripts/features/preferences.js?v=21.3.1',
  './icon-192.png',
  './icon-512.png',
