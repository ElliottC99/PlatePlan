import { assertAuthoritativeInterfaces } from './core/contracts.js?v=2.8.3';
import { createPlatePlanStore } from './core/store.js?v=2.8.3';
import { createPlatePlanRuntime } from './core/runtime.js?v=2.8.3';
import { createFirebaseService } from './services/firebase.js?v=2.8.3';
import { createSyncService } from './services/sync.js?v=2.8.3';
import { createRecoveryService } from './services/recovery.js?v=2.8.3';
import { createUpdateService } from './services/updates.js?v=2.8.3';
import { installDelegatedActions } from './ui/actions.js?v=2.8.3';
import { installNavigation } from './ui/navigation.js?v=2.8.3';
import { createWorkspaceService } from './ui/workspaces.js?v=2.8.3';
...
const updates = createUpdateService({
  ...
  workspaces,
  appVersion: '2.8.3',
  expectedCache: 'plateplan-shell-v64',
});
...
const syncRuntimeMarker = () => {
  document.documentElement.dataset.plateplanRuntime = '2.8.3';
...
window.dispatchEvent(new CustomEvent('plateplan:modules-ready', {
  detail: { version: '2.8.3', loadedViews: runtime.loadedViews() },
}));
