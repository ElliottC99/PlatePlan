import { assertAuthoritativeInterfaces } from './core/contracts.js?v=2.8.4';
import { createPlatePlanStore } from './core/store.js?v=2.8.4';
import { createPlatePlanRuntime } from './core/runtime.js?v=2.8.4';
import { createFirebaseService } from './services/firebase.js?v=2.8.4';
import { createSyncService } from './services/sync.js?v=2.8.4';
import { createRecoveryService } from './services/recovery.js?v=2.8.4';
import { createUpdateService } from './services/updates.js?v=2.8.4';
import { installDelegatedActions } from './ui/actions.js?v=2.8.4';
import { installNavigation } from './ui/navigation.js?v=2.8.4';
import { createWorkspaceService } from './ui/workspaces.js?v=2.8.4';
...
const updates = createUpdateService({
  ...
  workspaces,
  appVersion: '2.8.4',
  expectedCache: 'plateplan-shell-v65',
});
...
const syncRuntimeMarker = () => {
  document.documentElement.dataset.plateplanRuntime = '2.8.4';
...
window.dispatchEvent(new CustomEvent('plateplan:modules-ready', {
  detail: { version: '2.8.4', loadedViews: runtime.loadedViews() },
}));
