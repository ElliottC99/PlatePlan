import './core/legacy-bridge.js?v=3.3.4';
import { assertAuthoritativeInterfaces } from './core/contracts.js?v=3.3.4';
import { createPlatePlanStore } from './core/store.js?v=3.3.4';
import { createPlatePlanRuntime } from './core/runtime.js?v=3.3.4';
import { createFirebaseService } from './services/firebase.js?v=3.3.4';
import { initFirebaseService } from './services/firebase-service.js?v=3.3.4';
import { createSyncService } from './services/sync.js?v=3.3.4';
import { createRecoveryService } from './services/recovery.js?v=3.3.4';
import { createUpdateService } from './services/updates.js?v=3.3.4';
import { installDelegatedActions } from './ui/actions.js?v=3.3.4';
import { installNavigation } from './ui/navigation.js?v=3.3.4';
import { createWorkspaceService } from './ui/workspaces.js?v=3.3.4';

window.APP_VERSION = '3.3.4';
...
const syncRuntimeMarker = () => {
  document.documentElement.dataset.plateplanRuntime = '3.3.4';
...
window.dispatchEvent(new CustomEvent('plateplan:modules-ready', {
  detail: { version: '3.3.4', loadedViews: runtime.loadedViews() },
}));
