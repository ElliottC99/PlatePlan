import { assertAuthoritativeInterfaces } from './core/contracts.js?v=2.8.5';
import { createPlatePlanStore } from './core/store.js?v=2.8.5';
import { createPlatePlanRuntime } from './core/runtime.js?v=2.8.5';
import { createFirebaseService } from './services/firebase.js?v=2.8.5';
import { createSyncService } from './services/sync.js?v=2.8.5';
import { createRecoveryService } from './services/recovery.js?v=2.8.5';
import { createUpdateService } from './services/updates.js?v=2.8.5';
import { installDelegatedActions } from './ui/actions.js?v=2.8.5';
import { installNavigation } from './ui/navigation.js?v=2.8.5';
import { createWorkspaceService } from './ui/workspaces.js?v=2.8.5';
...
const updates = createUpdateService({
  ...
  workspaces,
  appVersion: '2.8.5',
  expectedCache: 'plateplan-shell-v67',
});
...
const syncRuntimeMarker = () => {
  document.documentElement.dataset.plateplanRuntime = '2.8.5';
...
window.dispatchEvent(new CustomEvent('plateplan:modules-ready', {
  detail: { version: '2.8.5', loadedViews: runtime.loadedViews() },
}));
