import { createPlatePlanStore } from './core/store.js?v=3.3.11';
import { createPlatePlanRuntime } from './core/runtime.js?v=3.3.11';
import { createFirebaseService } from './services/firebase.js?v=3.3.11';
import { initFirebaseService } from './services/firebase-service.js?v=3.3.11';
import { createSyncService } from './services/sync.js?v=3.3.11';
import { createRecoveryService } from './services/recovery.js?v=3.3.11';
import { createUpdateService } from './services/updates.js?v=3.3.11';
import { installDelegatedActions } from './ui/actions.js?v=3.3.11';
import { installNavigation } from './ui/navigation.js?v=3.3.11';
import { createWorkspaceService } from './ui/workspaces.js?v=3.3.11';

window.APP_VERSION = '3.3.11';
...
const syncRuntimeMarker = () => {
  document.documentElement.dataset.plateplanRuntime = '3.3.11';
...
import { deletePlan } from './core/store.js?v=3.3.11';
...
window.dispatchEvent(new CustomEvent('plateplan:modules-ready', {
  detail: { version: '3.3.11', loadedViews: runtime.loadedViews() },
}));
