import './core/legacy-bridge.js?v=3.3.3';
import { assertAuthoritativeInterfaces } from './core/contracts.js?v=3.3.3';
import { createPlatePlanStore } from './core/store.js?v=3.3.3';
import { createPlatePlanRuntime } from './core/runtime.js?v=3.3.3';
import { createFirebaseService } from './services/firebase.js?v=3.3.3';
import { initFirebaseService } from './services/firebase-service.js?v=3.3.3';
import { createSyncService } from './services/sync.js?v=3.3.3';
import { createRecoveryService } from './services/recovery.js?v=3.3.3';
import { createUpdateService } from './services/updates.js?v=3.3.3';
import { installDelegatedActions } from './ui/actions.js?v=3.3.3';
import { installNavigation } from './ui/navigation.js?v=3.3.3';
import { createWorkspaceService } from './ui/workspaces.js?v=3.3.3';

window.APP_VERSION = '3.3.3';
...
const syncRuntimeMarker = () => {
  document.documentElement.dataset.plateplanRuntime = '3.3.3';
...
window.dispatchEvent(new CustomEvent('plateplan:modules-ready', {
  detail: { version: '3.3.3', loadedViews: runtime.loadedViews() },
}));
