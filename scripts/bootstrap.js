 ...
 */
const CURRENT_BUILD_ID = '3.3.2-mod-v90';
...
await loadClassicScript('./scripts/plateplan-app.js?v=3.3.2-mod');
await import('./features/recipes.js?v=3.3.2-mod');
await import('./main.js?v=3.3.2-mod');
