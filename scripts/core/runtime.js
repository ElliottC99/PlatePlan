...
console.log('[PlatePlan v3.1.2] Engine initialized. Legacy keys purged.');

const FEATURE_LOADERS = Object.freeze({
  today: () => import('../features/today.js?v=3.1.2'),
  vault: () => import('../features/recipes.js?v=3.1.2'),
  add: () => import('../features/recipe-add.js?v=3.1.2'),
  ingredients: () => import('../features/ingredients.js?v=3.1.2'),
  bank: () => import('../features/products.js?v=3.1.2'),
  planner: () => import('../features/planner.js?v=3.1.2'),
  planlib: () => import('../features/library.js?v=3.1.2'),
  shopping: () => import('../features/shopping.js?v=3.1.2'),
  search: () => import('../features/search.js?v=3.1.2'),
  data: () => import('../features/data-quality.js?v=3.1.2'),
  prefs: () => import('../features/preferences.js?v=3.1.2'),
});
